...
export default function Library({ navigation }) {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await axios.get('https://www.googleapis.com/books/v1/volumes?q=subject:economics');
      ...
      <ImageBackground source={require('./images/bg.png')} style={styles.bg}>
        ...
        <View>
          <ScrollView style={styles.MainOption} horizontal={true} showsHorizontalScrollIndicator={false}>
            <TouchableOpacity style={styles.MainOptionTopicsLive} onPress={()=>navigation.navigate('Economics')}>
              <Text style={styles.MainOptionTopicsTextLive}>Economics</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Library')}>
            ...
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Horror')}>
              <Text style={styles.MainOptionTopicsText}>Horror</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('SelfHelp')}>
              <Text style={styles.MainOptionTopicsText}>Self Help</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('HealthFitness')}>
              <Text style={styles.MainOptionTopicsText}>Health & Fitness</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Drama')}>
              <Text style={styles.MainOptionTopicsText}>Drama</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Education')}>
              <Text style={styles.MainOptionTopicsText}>Education</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Religion')}>
              <Text style={styles.MainOptionTopicsText}>Religion</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Politics')}>
              <Text style={styles.MainOptionTopicsText}>Politics</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.MainOptionTopics} onPress={()=>navigation.navigate('Philosophy')}>
